...
#define POS_Y_TOTAL SCREEN_WIDTH-70
...
#define POS_Y_COUNTER SCREEN_WIDTH - 70

#define POS_X_OBSTACLE SCREEN_WIDTH + 100
#define POS_Y_OBSTACLE_1 SCREEN_HEIGHT/4 + 40
#define POS_Y_OBSTACLE_2 SCREEN_HEIGHT/4
#define POS_Y_OBSTACLE_3 SCREEN_HEIGHT/4 - 40
#define POS_Y_OBSTACLE_4 SCREEN_HEIGHT/4 - 80
